...
@AllArgsConstructor
@Slf4j
public class ServiceBoardClient implements BoardsClient<ServiceBoardsCommentsEntity> {
  ...
  private HttpStatus getStatus(long boardId, HttpMethod method) {
    try {
      ...
      String endpoint = userServiceUrl + "/private/service-boards/" + boardId + "/comments";
